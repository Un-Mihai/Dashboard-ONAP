    ...
    if not db.execute(query).fetchall():
        insert_query = text("""
                INSERT INTO dbo.METRICS (NAME,COMPONENTS,FORMULA,AGGREGATION,UNITS) VALUES
	                ...
	                ('Cell_Availability','VS.NCAV.SAMPLES_CELL_AVAIL,VS.NCAV.DENOM_CELL_AVAIL,VS.NCAV.NR_CELL_PLAN_UNAVAIL_SAMPLES','VS_NCAV_SAMPLES_CELL_AVAIL / (VS_NCAV_DENOM_CELL_AVAIL - VS_NCAV_NR_CELL_PLAN_UNAVAIL_SAMPLES) * 100','AVG','%'),
	                ...
	                ('RFM_Energy_Consumption','VS.SBTS_RFM_Energy_Monitoring.RU_AVG_PWR_USAGE','VS_SBTS_RFM_Energy_Monitoring_RU_AVG_PWR_USAGE / 1000','AVG','W');
                """)
